...
to_fp16_cuda_t ggml_get_to_fp16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_HXQ_AFFINE_G128:
            return dequantize_block_cont_cuda<QK_HXQ_AFFINE, QR_HXQ_AFFINE, dequantize_hxq_affine_g128>;
        case GGML_TYPE_HXQ_AFFINE_6:
            return dequantize_block_cont_cuda<QK_HXQ_AFFINE_6, QR_HXQ_AFFINE_6, dequantize_hxq_affine_6>;
        case GGML_TYPE_F32:
            return convert_unary_cont_cuda<float>;
        case GGML_TYPE_BF16:
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_HXQ_AFFINE_G128:
            return dequantize_block_cuda<QK_HXQ_AFFINE, QR_HXQ_AFFINE, dequantize_hxq_affine_g128>;
        case GGML_TYPE_HXQ_AFFINE_6:
            return dequantize_block_cuda<QK_HXQ_AFFINE_6, QR_HXQ_AFFINE_6, dequantize_hxq_affine_6>;
        case GGML_TYPE_BF16:

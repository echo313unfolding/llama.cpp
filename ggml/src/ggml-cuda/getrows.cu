...
static void ggml_cuda_get_rows_switch_src0_type(
    ...
    switch (src0_type) {
        ...
        case GGML_TYPE_HXQ_AFFINE_G128:
            get_rows_cuda_q<QK_HXQ_AFFINE, QR_HXQ_AFFINE, dequantize_hxq_affine_g128>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_HXQ_AFFINE_6:
            get_rows_cuda_q<QK_HXQ_AFFINE_6, QR_HXQ_AFFINE_6, dequantize_hxq_affine_6>(src0_d, src1_d, dst_d,
                ne00, nb01, nb02, nb03, ne10, ne11, ne12, nb10, nb11, nb12, nb1, nb2, nb3, stream);
            break;
        case GGML_TYPE_Q4_0:

...
GGML_API void quantize_row_hxq_affine_g128_ref(const float * GGML_RESTRICT x, block_hxq_affine_g128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_hxq_affine_6_ref(const float * GGML_RESTRICT x, block_hxq_affine_6 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_hxq_affine_g128(const block_hxq_affine_g128 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_hxq_affine_6(const block_hxq_affine_6 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_hxq_affine_g128(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_hxq_affine_6(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
